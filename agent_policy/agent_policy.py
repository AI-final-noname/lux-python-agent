...
class AgentPolicy(AgentWithModel):
    ...
    def get_reward(self, game, is_game_finished, is_new_turn, is_game_error):
        ...
        rewards["rew/r_units"] = (unit_count-self.units_last - difficulty* (opponent_unit_count-self.o_units_last)) * 1*turn_loss
        self.units_last = unit_count
        self.o_units_last = opponent_unit_count
        # Give a reward for city creation/death. 0.1 reward per city.
        rewards["rew/r_city_tiles"] = (city_tile_count-self.city_tiles_last+difficulty*self.o_city_tiles_last - difficulty*city_tile_count_opponent) * 3*ins_turn_loss
