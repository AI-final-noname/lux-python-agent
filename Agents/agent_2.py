...
class AgentPolicy(AgentWithModel):
    ...
    def get_reward(self, game, is_game_finished, is_new_turn, is_game_error):
        ...
        rewards["research_point"] = (
            research_point - self.research_point_last) * 0.004
        ...
        rewards["city_tile_number"] = (city_tile_number - self.city_tile_number_last - difficult * (
            oppo_city_tile_number - self.o_city_tile_number_last)) * 0.6
        ...
        rewards["worker_number"] = (worker_number - self.worker_number_last -
                                    difficult * (oppo_worker_number - self.o_worker_number_last)) * 0.06
        self.worker_number_last = worker_number
        self.o_worker_number_last = oppo_worker_number

        rewards["cart_number"] = (cart_number - self.cart_number_last -
                                  difficult * (oppo_cart_number - self.o_cart_number_last)) * 0.04
        ...
        oppo_wood_number = game.stats["teamStats"][(
            self.team + 1) % 2]["resourcesCollected"]["wood"]
        oppo_coal_number = game.stats["teamStats"][(
            self.team + 1) % 2]["resourcesCollected"]["coal"]
        oppo_uranium_number = game.stats["teamStats"][(
            self.team + 1) % 2]["resourcesCollected"]["uranium"]

        rewards["wood_number"] = (wood_number - self.wood_number_last - difficult * (
            oppo_wood_number - self.o_wood_number_last)) * 0.000006
        self.wood_number_last = wood_number
        self.o_wood_number_last = oppo_wood_number

        rewards["coal_number"] = (coal_number - self.coal_number_last -
                                  difficult * (oppo_coal_number - self.o_coal_number_last)) * 0.00005
        self.coal_number_last = coal_number
        self.o_coal_number_last = oppo_coal_number

        rewards["uranium_number"] = (uranium_number - self.uranium_number_last - difficult * (
            oppo_uranium_number - self.o_uranium_number_last)) * 0.00008
